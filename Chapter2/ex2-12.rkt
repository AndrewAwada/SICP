...
; ex 2.13
(define x1 (make-center-percent 5 2))
(define x2 (make-center-percent 7 3))

(percent (mul-interval x1 x2)) ; is approximately 2 + 3 = 5
...
(define A (div-interval x1 x1))
(define B (div-interval x1 x2))
